    ...
    <div className="card w-72 h-9/11 bg-base-100 shadow-xl hover:-translate-y-1 hover:scale-110 hover:duration-500 ">
      ...
      <div className="card-body text-center">
        ...
        <div className="card-actions justify-center">
          <button onClick={() => navigateToShopDetails(_id)} className=" bg-blue-700 px-9 lg:px-10  py-1 font-semibold text-lg hover:bg-blue-900  text-white">Add To Cart</button>
        </div>
      </div>
    </div>
  );
